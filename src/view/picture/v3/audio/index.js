...
// 音频转码worker
// let recorderWorker = new Worker('http://q281hjyei.bkt.clouddn.com/transformpcm.worker.js');
...
function WorkerStart() {
  XHRWorker("http://q281hjyei.bkt.clouddn.com/transformpcm.worker.js", function(worker) {
...
class IatRecorder {
  constructor (config) {
    ...
    this.appId = '5a405607' 
    this.apiKey = '6ad8fa5cf6726f5d662f636033eb2b63'
    this.apiSecret = 'ffb05998f04f49297ef8448ff92625f2'
  }
...
class IatTaste {
  ...
  setResult (data) {
    ...
    new Vue().$msg.$emit('message-iat', resultStr);
  }
